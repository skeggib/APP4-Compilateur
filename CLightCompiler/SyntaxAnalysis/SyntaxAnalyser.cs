    ...
    public class SyntaxAnalyser
    {
        ...
        private Node Comparaison()
        {
            ...
            switch (_tokens[_index].Category)
            {
                case TokenCategory.TokEquals:
                    op = new Node(NodeCategory.NodeEquals, null, t);
                    break;

                case TokenCategory.TokNotEquals:
                    op = new Node(NodeCategory.NodeNotEquals, null, t);
                    break;
                ...
                case TokenCategory.TokLowerOrEquals:
                    op = new Node(NodeCategory.NodeLowerOrEquals, null, t);
                    break;

                case TokenCategory.TokGreaterOrEquals:
                    op = new Node(NodeCategory.NodeGreaterOrEquals, null, t);
                    break;
        ...
        private Node Logic()
        {
            ...
            if (_tokens[_index].Category == TokenCategory.TokAnd)
                op = new Node(NodeCategory.NodeAnd, null, c);
            else
                return c;
        ...
        private Node Expression()
        {
            ...
            if (_tokens[_index].Category == TokenCategory.TokOr)
                op = new Node(NodeCategory.NodeOr, null, l);
            else
                return l;
